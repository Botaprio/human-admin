        ...
        <div class="col-span-6 sm:col-span-4">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-input id="second_name" type="text" class="mt-1 block w-full" wire:model="state.second_name" autocomplete="additional-name" />
                    <x-input-error for="second_name" class="mt-2" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                ...
                <div>
                    ...
                    <x-input id="second_last_name" type="text" class="mt-1 block w-full" wire:model="state.second_last_name" autocomplete="additional-name" />
